...
export const ProtectedLayout = ({ children }: { children: JSX.Element }) => {
  ...
  if (!auth.username) {
    return (
      <section className="grid grid-cols-1 h-screen w-full flex items-center h-full sm:p-16 dark:bg-gray-900 dark:text-gray-100">
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
          ...
          <p className="text-3xl">It is not possible to access this page before login</p>
